...
**Launch completeness:** **~82%** (P-001/#27; P-003/4/#29; P-005/#28; P-006 closed here)  
...
| P-003 / P-004 | CVE + fail-closed CI | PR #29 |
| P-005 | OpenAPI lockdown | PR #28 |
| P-006 | FK covering indexes | **CLOSED** |
| P-002, P-007–P-009 | See `docs/LAUNCH_BLOCKERS.md` | Remaining |

## Remaining blockers (P1)

Hosted DR sign-off (human), AGENTS.md on default branch, observability/on-call, Numeric(10,2) spend precision limits.
