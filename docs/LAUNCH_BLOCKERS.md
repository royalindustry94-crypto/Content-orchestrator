...
| P-009 | Spend Numeric precision | **CLOSED** | Caps `numeric(12,4)`; `test_spend_precision_p1.py` |

**Alembic note:** Parallel P1 branches introduce distinct `0031_*` revisions off `0030`. Linearize heads before merging multiple schema PRs.
