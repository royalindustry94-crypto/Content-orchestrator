...
| P-002 | Hosted backup restore drill sign-off | OPEN | **Blocked: human / hosted credentials** |
...
| P-006 | Unindexed FK columns | In progress on PR #30 | Separate branch |
| P-007 | AGENTS.md / Cursor rules | In progress on PR #32 | Separate branch |
| P-008 | Observability / on-call | **CLOSED** (in-repo) | `GET /metrics` + `docs/ops/ON_CALL.md` |
| P-009 | Spend Numeric precision | In progress on PR #31 | Separate branch |
