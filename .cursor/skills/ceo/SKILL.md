...
description: >-
  ...
  /content-orchestrator-expert, product architecture to /chief-architect,
  Executive Operations Hub architecture to /executive-operations-hub-architect,
...
- Order specialists: `/content-orchestrator-expert`, `/chief-architect`, `/executive-operations-hub-architect`, `/postgresql-expert`, `/backend-engineer`, `/frontend-engineer`, `/devops-engineer`, `/release-manager`, `/documentation-writer`
...
- Author or sync milestone/architecture/API docs as primary deliverable instead of `/documentation-writer`
...
| Architecture/API/migration/ops docs, ADR drafts, impl/audit prose | `/documentation-writer` |
