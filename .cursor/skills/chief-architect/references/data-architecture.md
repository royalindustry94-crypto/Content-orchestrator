...
> **Authority note:** Chief Architect requires these invariants in designs.
> Deep DDL, RLS policy SQL, Alembic text, EXPLAIN, and lock review belong to
> `/postgresql-expert`. Do not treat Architect APPROVE as PG sign-off.
