...
|---|---|---|---|
| Product scope, quality bar, go/no-go, product VERIFIED label | `/ceo` | Specialists + `/release-manager` readiness + `/security-auditor` when security-sensitive | Implement specialist deep work as substitute for delegation |
